...
private:
   ...
   */ // TODO
  BSTIterator(BSTNode<Data>* curr) : curr(curr) {       //initializer list
  }
...
public:
  ...
  bool operator==(BSTIterator<Data> const & other) const {
    return other.curr == curr;    // check two iterators are equivalent
  }

  /** Inequality test operator. */ // TODO
  bool operator!=(BSTIterator<Data> const & other) const {
    return other.curr != curr;    // check two iterators are not equivalent
  }
